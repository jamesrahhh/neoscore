...
class BrowserScoresheetCreationDialog extends StatefulWidget {
  ...
  @override
  State<BrowserScoresheetCreationDialog> createState() => _BrowserScoresheetCreationDialogState();
}

class _BrowserScoresheetCreationDialogState extends State<BrowserScoresheetCreationDialog> {
                  ...
                  child: TextButton(
                    onPressed: () async {
                      final Scoresheet scoresheet =
                          await Provider.of<BrowserViewModel>(context, listen: false)
                              .createScoresheet(
